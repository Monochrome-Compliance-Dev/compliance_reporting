// src/v2/ptrs/screens/PtrsMetricsDashboard.js
import {
  Box,
  Chip,
  Divider,
...
import { usePtrsMetricsSummary } from "v2/ptrs/hooks/usePtrsQueries";
...
export default function PtrsMetricsDashboard() {
  ...
  const onChangePtrs = (nextId) => {
    ...
    if (nextId) next.set("ptrsId", nextId);
    else next.delete("ptrsId");

    // Clear any old param from previous iterations.
