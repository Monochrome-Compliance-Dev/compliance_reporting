import { usePtrsContext, useAlert } from "context";
...
export default function DataConsole() {
  ...
  const goToMapping = () => {
    ...
    window.location.assign(`/v2/ptrs/map?runId=${encodeURIComponent(ptrsId)}`);
  };
    ...
    >
      ...
      <Box sx={{ mb: 4 }}>
        <Paper elevation={3} sx={{ padding: theme.spacing(3) }}>
          ...
          {!isCreateCollapsed && <CreateRunCard onSuccess={refreshPtrs} />}
        </Paper>
      </Box>
